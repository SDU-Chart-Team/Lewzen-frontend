...
const CONST = 0, UNARY = 1, BINARY = 2, INFIX = 3, LEFTBRACKET = 4,
    RIGHTBRACKET = 5, SPACE = 6, UNDEROVER = 7,
    TEXT = 8; // token types
...
//{input:"{}",		  tag:"mo", output:"\u200B", ttype:CONST}, // zero-width
    ...
    {input: "\\surd", tag: "msqrt", output: "", ttype: CONST},
...
// let msg = '\\begin{array}{ccc}\n' +
//     '    1 & 0 & 0\\\\\\\\\n' +
//     '    0 & 1 & 0\\\\\\\\\n' +
//     '    0 & 0 & 1\\\\\\\\\n' +
//     '\\end{array}'
// let msg = '\\surd\\sqrt{1+\\sqrt{1+\\sqrt{1+\\sqrt{1+\\sqrt{1+\\sqrt{1+\\sqrt{1+x}}}}}}}'
// let msg = '\\Gamma(t) = \\lim_{n \\to \\infty} \\frac{n! \\; n^t}{t \\; (t+1)\\cdots(t+n)}= \\frac{1}{t} \\prod_{n=1}^\\infty \\frac{\\left(1+\\frac{1}{n}\\right)^t}{1+\\frac{t}{n}} = \\frac{e^{-\\gamma t}}{t} \\prod_{n=1}^\\infty \\left(1 + \\frac{t}{n}\\right)^{-1} e^{\\frac{t}{n}}'
