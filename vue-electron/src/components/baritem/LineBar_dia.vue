...
<script>
    ...
    import {dialog_style_get} from "../../js/canvas/operation/canvas_style_operation";

    export default {
        name: "LineBar_dia",
        mounted() {
            window.setStrokeStyleDia=this.setStrokeStyle;
            window.setStrokeFlagDia=this.setStrokeFlag;
            let msg=dialog_style_get()
            this.setStrokeStyle(msg);
        },
        methods:{
            setStrokeFlag(flag){
                this.flag=flag;
